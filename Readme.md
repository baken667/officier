...
Добавлены воспроизводимые патчи: снимаются квоты подключений Community и включаются
флаги брендинга, кастомизации и advanced API. `bootstrap.sh` применяет их автоматически.
Добавлена контейнерная сборка собственного серверного runtime на базе ONLYOFFICE 9.4.0.
Перед публикацией workflow проверяет открытие, изменение и сохранение DOCX в Chromium,
режим просмотра и JWT. Нативный конвертер и frontend-ресурсы поставляются из upstream образа.

- [Репозиторий Officier](https://github.com/baken667/officier)
- [Контейнер: запуск, сборка и публикация](docs/container.md)
- [Подготовка исходников и план кастомизации](docs/officier.md)
- [Патчи и границы изменений](patches/README.md)
- [Свой React-интерфейс без iframe](docs/react-without-iframe.md)
- [Репозиторий React-пакета](https://github.com/baken667/officier-react) — начальный мост команд и панель; монтаж движка ещё не реализован
